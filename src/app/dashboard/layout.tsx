...
const menuConfig: Record<Role, MenuItem[]> = {
  admin: [
    ...
    { id: "agencies", name: "Agency Verification", icon: ShieldCheck, href: "/dashboard/admin/agencies" },
    { id: "users", name: "Users", icon: Users, href: "/dashboard/admin/users" },
    { id: "packages", name: "Packages", icon: FileText, href: "/dashboard/admin/packages" },
    { id: "bookings", name: "Bookings", icon: ClipboardList, href: "/dashboard/admin/bookings" },
    { id: "finance", name: "Finance", icon: DollarSign, href: "/dashboard/admin/finance" },
  ],
  agency: [
    { id: "overview", name: "Overview", icon: ChartSpline, href: "/dashboard/agency" },
    { id: "add-package", name: "Add Package", icon: Plus, href: "/dashboard/agency/packages/new" },
    { id: "packages", name: "My Packages", icon: MapPinned, href: "/dashboard/agency/packages" },
    { id: "bookings", name: "Bookings", icon: ClipboardList, href: "/dashboard/agency/bookings" },
    { id: "inquiries", name: "Inquiries", icon: MessageSquare, href: "/dashboard/agency/inquiries" },
    { id: "earnings", name: "Earnings", icon: DollarSign, href: "/dashboard/agency/earnings" },
    { id: "profile", name: "Agency Profile", icon: Building2, href: "/dashboard/agency/profile" },
  ],
  traveler: [
    { id: "overview", name: "Dashboard", icon: ChartSpline, href: "/dashboard/traveler" },
    { id: "browse", name: "Browse Tours", icon: SearchCheck, href: "/dashboard/traveler/browse" },
    { id: "bookings", name: "My Bookings", icon: MonitorDot, href: "/dashboard/traveler/bookings" },
    { id: "wishlist", name: "Wishlist", icon: Heart, href: "/dashboard/traveler/wishlist" },
    { id: "reviews", name: "My Reviews", icon: Star, href: "/dashboard/traveler/reviews" },
    { id: "profile", name: "Edit Profile", icon: UserRoundPen, href: "/dashboard/traveler/profile" },
  ],
};
