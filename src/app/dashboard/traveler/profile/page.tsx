...
const TRAVELER_ID = "6a52501314fcefee1fd7e631"; // আপনার dynamic travelerId / auth session থেকে বসাবেন
...
export default function TravelerProfilePage() {
  ...
  const fetchProfile = useCallback(async () => {
    ...
    setError(null);
    try {
      const res = await fetch(`${API_BASE}/api/traveler/profile/${TRAVELER_ID}`);
...
function DataRow({
  ...
  return (
    <div className="flex flex-col gap-1.5 min-w-0">
      ...
      <span
        className={`block text-[15px] break-words capitalize ${
