...
export default function RegisterForm() {
    ...
    const handleRoleChange = (role: "traveler" | "agency") => {
        setUserRole(role);
        reset({ role: role, terms: false, password: "", confirmPassword: "", email: "", phone: "", fullName: "", agencyName: "", tradeLicense: "", operatingRegion: "" });
    ...
    return (
        <div className="max-w-5xl w-full mx-auto bg-white rounded-3xl shadow-2xl overflow-hidden font-sans my-10 border border-gray-100">
            ...
            {/* Form wrapping the entire block and trigger onSubmit via react-hook-form */}
            <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 lg:grid-cols-12 min-h-[680px]">
                ...
                <div className="lg:col-span-5 p-6 sm:p-10 flex flex-col justify-between bg-white">
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className={`w-full pl-9 pr-4 py-2 text-sm text-gray-800 bg-gray-50/50 rounded-xl border focus:outline-none focus:ring-2 transition-all ${errors.phone ? "border-red-400 focus:ring-red-100" : "border-gray-200 focus:ring-blue-50 focus:border-blue-500"}`}
                                    />
                                </div>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className={`w-full pl-9 pr-10 py-2 text-sm text-gray-800 bg-gray-50/50 rounded-xl border focus:outline-none focus:ring-2 transition-all ${errors.confirmPassword ? "border-red-400 focus:ring-red-100" : "border-gray-200 focus:ring-blue-50 focus:border-blue-500"}`}
                                    />
                                    <button
                                        type="button"
                    ...
                    <div className="mt-5 pt-3 border-t border-gray-100">
                        ...
                        {/* Main Submit Button (FIXED: Button in button issue resolved) */}
                        <button
                            type="submit"
                            disabled={isSubmitting}
                            className={`w-full flex items-center justify-center gap-2 font-bold text-sm text-white py-2.5 px-4 rounded-xl shadow-md transition-all ${userRole === "traveler" ? "bg-blue-600 hover:bg-blue-700 shadow-blue-600/10" : "bg-orange-500 hover:bg-orange-600 shadow-orange-500/10"} disabled:opacity-50`}
                        >
                            {isSubmitting ? (
                ...
                <div className="lg:col-span-7 relative flex flex-col justify-between p-6 sm:p-10 bg-slate-950 text-white min-h-[400px] lg:min-h-full">
                    ...
                    <div className="absolute inset-0 z-0">
                        <div
                            className={`absolute inset-0 bg-cover bg-center transition-all duration-700 ease-in-out ${userRole === "traveler" ? "opacity-40 scale-100" : "opacity-0 scale-95"}`}
                        ...
                        />
                        <div
                            className={`absolute inset-0 bg-cover bg-center transition-all duration-700 ease-in-out ${userRole === "agency" ? "opacity-40 scale-100" : "opacity-0 scale-95"}`}
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            {...register("fullName", { required: userRole === "traveler" ? "Full name is required" : false })}
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            {...register("agencyName", { required: userRole === "agency" ? "Company name is required" : false })}
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            {...register("tradeLicense", { required: userRole === "agency" ? "Trade license number is mandatory" : false })}
                                            className="w-full pl-9 pr-4 py-2 text-sm text-white bg-slate-900/40 border border-white/10 rounded-xl placeholder-slate-400 focus:outline-none focus:border-orange-400 transition-all"
                                        />
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            {...register("operatingRegion", { required: userRole === "agency" ? "Operating zone is required" : false })}
                                            className="w-full pl-9 pr-4 py-2 text-sm text-white bg-slate-900/40 border border-white/10 rounded-xl placeholder-slate-400 focus:outline-none focus:border-orange-400 transition-all"
                                        />
                                    </div>
